...
namespace AggregateOperators
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // --- CHANGE ---
            // Uncommented all the sample methods to execute all of them,
            // instead of asking the user to comment/uncomment.
            // --- CHANGE ---
        ...
        class LinqSamples
        {
            ...
            private void createLists()
            {
                ...
                // --- CHANGE ---
                // Use embedded resources for the XML file instead of relying on
                // availability of the file in the current working directory.
                // --- CHANGE ---
                var customersStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("AggregateOperators.customers.xml");

                // Customer/Order data read into memory from XML file using XLinq:
                customerList = (
                    from e in XDocument.Load(customersStream).
